...
export default function ViewInventory() {
    ...
    const handleFileChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        const newItems: InventoryItem[] = lines.slice(1).map(line => {
            ...
            return { name: obj.name, quantity: Number(obj.quantity), category: obj.category, expirationDate: obj.expirationDate };
        });
    ...
    return (
        <NextThemesProvider defaultTheme="system" attribute="class">
            ...
            <div className="relative flex min-h-screen bg-white dark:bg-gray-900 overflow-hidden">
                ...
                <Sidebar activePage="view" setActivePage={() => { }} groups={sidebarGroups} /> {/* using shared sidebarGroups */}
