			...
			<div className="relative flex min-h-screen bg-white dark:bg-gray-900 overflow-hidden">
				...
				<main className="flex-1 p-6 overflow-y-auto">
					<motion.div
						...
						initial="hidden"
						animate="visible"
						className="max-w-md mx-auto p-6 rounded-lg shadow-lg bg-white/30 dark:bg-gray-800/30 backdrop-blur-md border border-white/20 dark:border-gray-700/20"
					>
						...
						>
							<motion.div variants={fieldVariants}>
								...
								<input
									...
									className="w-full p-3 bg-gray-100 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-primary-500"
								/>
								<motion.button
									type="button"
									onClick={scan}
									...
									whileHover="hover"
									whileTap="tap"
									className="mt-2 inline-flex items-center gap-2 px-4 py-2 bg-primary-600 hover:bg-primary-700 text-white rounded-md"
								>
							...
							<motion.button
								...
								whileHover="hover"
								whileTap="tap"
								className="cursor-pointer w-full py-3 bg-primary-600 hover:bg-primary-700 text-white rounded-md"
							>
								Add Item
							</motion.button>
						</motion.form>
